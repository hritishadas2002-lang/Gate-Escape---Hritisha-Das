...
6. **Business Recommendations** *(Strategy)* — evidence-linked recommendations on which
   segments, confidence bands, channels, and tiers to prioritise, plus limitations.
7. **Data Preparation Evidence** *(Data preparation)* — concise evidence of how raw issues
   were handled, why clean/derived columns were created, and how missingness flags preserve data quality.
